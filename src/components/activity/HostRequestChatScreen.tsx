...
import { Activity, User as UserType, ChatMessage, JoinRequest } from '../../types';
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      >
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm text-gray-600">{joinRequest.requesterName}</span>
        </div>
      </motion.div>
        ...
        <div className="bg-gray-50 border-t border-gray-200 px-4 py-3">
          <div className="text-center">
            <p className={`text-sm font-medium ${
              joinRequest.status === 'approved' ? 'text-green-600' : 'text-red-600'
            }`}>
              Request {joinRequest.status === 'approved' ? 'Approved' : 'Declined'}
            </p>
