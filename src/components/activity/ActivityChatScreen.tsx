...
export const ActivityChatScreen: React.FC<ActivityChatScreenProps> = ({
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    ...
    },
    {
      ...
      message: "Hey everyone! Looking forward to meeting you all at this activity. Feel free to ask any questions!",
  ...
  const handleSend = () => {
    if (message.trim()) {
      ...
      setTimeout(() => {
        ...
        const otherParticipants = activity.attendees.filter(attendee => attendee.id !== user.id);
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        {messages.map((msg, index) => {
          ...
          const showAvatar = !isCurrentUser && !isSystem && (index === 0 || messages[index - 1].userId !== msg.userId);
