/*
  ...
  1. Changes
    - Ensure the updated_at column exists on join_requests table
    - Create or replace the handle_updated_at function without dropping it first
    - Create or replace triggers for all tables that use the updated_at functionality
*/
