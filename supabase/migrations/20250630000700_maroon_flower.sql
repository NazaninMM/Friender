/*
  # Create Direct Message and Chat Message Tables

  1. New Tables
    - `direct_messages` - Stores private conversations between two users
    - `chat_messages` - Stores messages for direct conversations

  2. Indexes
    - Added performance indexes for participants and timestamps
  ...
  4. Triggers
    - Added updated_at triggers for timestamp management
*/
...
CREATE TABLE IF NOT EXISTS public.direct_messages (
  ...
  CONSTRAINT direct_messages_participant1_participant2_key UNIQUE (participant1_id, participant2_id)
);
